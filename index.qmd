...
- Although this framework is designed for programming, we expanded its scope to make it compatible with data science. 
  - We decided to retain the exact definitions of syntactic and strategic knowledge because they aligned well with the content covered in the IDS courses examined in our study.
...
- We completed data analysis for the knowledge of students' understanding to determine which concepts/tasks IDS students experience difficulties. 
